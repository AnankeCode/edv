...
import view.PreguntasJpa;
import view.ResPreguntasJpa;
...
public class BeanVoto implements Serializable {
    ...
    @EJB
    private ResPreguntasJpa resPreguntasController;
    @EJB
    private PreguntasJpa preguntasController;
    ...
    public void listarEncuestas(){        
        List<Preguntas> listaEncuesta = preguntasController.listarEncuestas();
    ...
    public void obtenerDatosOpciones(){        
        ...
        numeroOpcion.clear();
        nomOpciones.clear();
        List<ResPreguntas> listaOpciones = resPreguntasController.obtenerOpcionesEncuesta(numEncuesta);        
        for (ResPreguntas po : listaOpciones) {                                                
    ...
    public void calcularPorcentajes(){        
        porcVotos.clear();
        long cantidad = resPreguntasController.obtenerCantidadVotos(numEncuesta);      
        for(Integer v:votos){
    ...
    public String sumarVoto(){
        ...
        resPreguntasController.sumarVoto(opcion);
